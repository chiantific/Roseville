                                       ...
                                       <ol>
                                        <li>
                                          ...
                                          <a class="page-scroll" href="https://www.escapegamepass.ch/validation-passeport/" target="_blank">
                                            <?php echo $lang['escapegamepass']; ?>
                                          </a>
                                        </li>
                                        <li>
                                          <?php echo $lang['answer_reservation_escapegamepass2']; ?>
                                        </li>
                                        <li>
                                          <?php echo $lang['answer_reservation_escapegamepass3']; ?>
                                        </li>
                                        <li>
                                          <?php echo $lang['answer_reservation_escapegamepass4']; ?>
                                        </li>
                                        <li>
