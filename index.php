        ...
        <div id="intro">
            <div class="container">
                <div class="row">
                    ...
                    <a href="paleo_raffle.html">
                        <img src="img/stain.png" alt="tombola pour gagner 2 billets pour le Paléo 2017" style="margin-top:40px;" onmouseover="this.src='img/stain_hover.png'" onmouseout="this.src='img/stain.png'"/>
                    </a>
                </div>
                <div class="row">
