                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>
                                        <?php
                                            echo $lang['popup_ligne1'];
                                        ?>
                                    </p>
                                    <p>
                                        <?php
                                            echo $lang['popup_ligne2'];
                                        ?>
                                    </p>
                                    <p>
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-default btn-sm btn-popup" data-dismiss="modal">
                                                <?php echo $lang['close']; ?>
                                    </button>
                                </div>
                            </div>
        ...
        <div id="section3">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 sub-section">
                        <img src="/static/img/R_de_fete1.jpg"
