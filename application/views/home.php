            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <img src="<?php echo $this->config->item('base_url'); ?>/assets/img/chocolat.jpg"
                             alt="chocolat fondant pour illustrer la salle chocolat" class="img-thumbnail" width="100%" />
                    ...
                    <img src="<?php echo $this->config->item('base_url'); ?>/assets/img/raisin.jpg"
                        ...
                        <h3><?php echo $this->lang->line('header_coming_soon'); ?></h3>
                        <p><?php echo $this->lang->line('text_coming_soon');
                            echo $this->lang->line('in_vino_veritas'); ?>
                        </p>
                        <a data-html="true" type="button" class="btn btn-default bottom" data-toggle="popover"
                           data-content="<?php echo $this->lang->line('curious') . '<br />'. $this->lang->line('be_patient'); ?>"
                           href="#">
                                <?php echo $this->lang->line('btn_more_info'); ?>
                        </a>
                    </div>
