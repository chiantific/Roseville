...
$lang['welcome_to_roseville'] = 'Welcome to Roseville Escape Room';
$lang['intro_text'] = 'Find the clues, solve the puzzles, beat the clock. Will you escape in time ?';
$lang['enter'] = 'Enter';
$lang['header_adventure_heros'] = 'The adventure in which you are the heros';
$lang['text_adventure_heros'] = 'An unforgettable life-sized adventure game in an unusual immersive setting. Each room is themed and has a unique storyline that engages the participants through their environment. Players in groups from 2 to 6 are locked into a room and have 60 minutes to find a way to escape. Use teamwork along with the room elements to find clues. Combine them to solve a series of puzzles and discover your way out.';
$lang['alt_lock_to_illustrate_the_game'] = 'Lock to illustrate the game';
$lang['header_game_univers'] = 'The game\'s universe';
$lang['text_game_univers'] = 'Dive into a thrilling life-size adventure within stunningly fantasy inspired settings';
...
$lang['text_the_clock_is_ticking'] = 'Work as a team to succeed in your mission. You will receive a price if you find a way to espace in less than 60 minutes';
$lang['text_what_public'] = 'The Roseville escape game is aimed at an audience of over 14 years old. Our enigmas contain no physical or frightening elements. The scenario was designed to satisfy the interest of novices, as well as that of experienced escape gamers.';
$lang['header_family_and_friends'] = 'Family and friends';
$lang['text_family_and_friends'] = 'Are you looking for a memorable and stimulating activity to share with friends or family members? Working as team to solve the mysteries at Roseville Escape will have your group talking for years to come.';
...
$lang['header_compagnies'] = 'Compagnies';
$lang['text_compagnies'] = 'A new opportunity to promote group cohesion or to organize job interviews';
$lang['text_our_rooms'] = 'Come to Roseville Escape for a live adventure in incredibly well done decors and discover the room "Chocolat" and our pre-game area "R"';
...
$lang['text_area_R'] = 'The "R" lounge for a festive atmosphere. We are pleased to receive you in a surprising setting where our coach will introduce the escape game. You are also welcome to stay for a drink and de-brief in this magical and relaxing environment after your session. This lounge is available for rent for birthdays, parties or private events.';
$lang['sub_header_gift_card'] = 'Gift card for a game at Roseville Escape, valid for a group of 2 to 5 persons, price CHF 140.-';
$lang['how_to_order_gift_card'] = 'A gift card for a Roseville Escape game is an original and appreciated gift. We provide nicely designed vouchers for you to gift loved ones at any occasion. To order please contact us using the ';
$lang['contact_form'] = 'contact page';
$lang['happy_to_send'] = 'We will be happy to send it to anyone you wish.';
$lang['payment_gift_card'] = 'Detailed information about the payment will be provided immediately by email. Subsequently, the gift card will be deliverered by post (snail) mail upon confirmation of the payement.';
$lang['how_to_use_gift_card'] = 'To redeem a gift certificate, kindly contact us by ';
...
$lang['text_what_you_get'] = 'You book for an entire game session for a group from 2 to 5. We are limiting the size of groups to 6 persons to make sure you will have the optimum experience at Roseville Escape Room';
$lang['prices'] = 'Pricing';
...
$lang['answer_how_to_pay'] =  'Payment is made at the time of reservation on the internet, by credit card: Visa, Mastercard and American Express. Paying by bank transfer is also possible. In addition, you can visit Roseville in person to reserve and pay by cash. Please contact us in advance to ensure our presence on site.';
$lang['question_opening_hours'] =  'Opening hours';
$lang['monday_tuesday'] =  'Monday/Tuesday: closed';
$lang['wednesday_thursday_friday_hours'] =  'Wednesday/Thursday/Friday: 4:30 - 10:30 pm';
$lang['saturday_sunday'] = 'Saturday/Sunday: 10:30 am - 10:30 pm';
$lang['question_where_location'] = 'Where are we located ?';
$lang['answer_where_location'] = 'Roseville Escape is located on route de Lavaux 44, 1802 Corseaux. It is only 2 minutes away from Vevey going towards Lausanne. See ';
$lang['map'] = 'map.';
...
$lang['answer_showing_up_without_reservation'] = 'No, prior booking at least two days in advance is required . This allows us to organize the game ahead of time to welcome you in the best conditions. If you have received a gift card, kindly contact us via the ';
...
$lang['text_address'] = 'Roseville Escape is located nearby Vevey on 44 route de Lavaux in Corseaux, Switzerland. The building lays in between the Leman lake and the world\'s heritage terrace vineyard Lavaux and Leman lake (aka Geneva lake).';
